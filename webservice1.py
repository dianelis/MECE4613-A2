...
def parse_args():
    ...
    parser.add_argument('name', help='name of the motion')    # the name of the motion: forward, backward, etc.
    parser.add_argument('--duration', help='duration of the motion', type=float)    # duration of that motion
    parser.add_argument('--speed', help='speed of the motion', type=int)            # the speed of that motion
...
def main():
    ...
    args = parse_args()
    name = args.pop('name')    # the name of the function to do the motion: forward, backward, etc.
